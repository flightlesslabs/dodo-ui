import{p as z,f as B,a as N,n as u,g as h,H as c,s as P,b as i,c as w,t as f,e as D,h as _}from"./iframe-Dm2oeldt.js";import{c as S,d as T}from"./create-runtime-stories-DwmOa5kD.js";import{i as q}from"./lifecycle-CgTGwIUP.js";import{C}from"./CalendarDateChip-B0S_tDGF.js";import{storyCalendarDateChipArgTypes as A}from"./CalendarDateChip.stories-B3nqUjr7.js";import"./Popper-BTA-ov8j.js";import{g as e}from"./getMoment-DtA9pdSi.js";import{B as E}from"./Button-Dnq_sH0K.js";import"./MenuItem-DlUHDrj0.js";import"./this-5OZYxuTc.js";import"./roundness-fyqvrcF6.js";import"./colors-C3b1rS-d.js";import"./size-C-8mwSpB.js";import"./attributes-CLo3BtRJ.js";import"./style-C9bfH9eW.js";import"./Paper-DZtFFZ_D.js";const H={component:C,tags:["autodocs"],argTypes:A,parameters:{docs:{description:{component:""}}}},{Story:$}=T();var R=B("<!> <!>",1);function g(v,y){z(y,!1),q();var m=R(),d=N(m);$(d,{name:"customCalendarDateChipContent",asChild:!0,children:(a,x)=>{{const o=(r,s=u)=>{var t=f();D(p=>_(t,`🗓️${p??""}`),[()=>Number(e(s().date).format("D"))]),i(r,t)};let n=c(()=>({id:"1",date:e().toDate(),isCurrentMonth:!0}));C(a,{get dayOfMonth(){return h(n)},customCalendarDateChipContent:o,$$slots:{customCalendarDateChipContent:!0}})}},$$slots:{default:!0},parameters:{docs:{description:{story:"Custom Content"}},__svelteCsf:{rawCode:`<CalendarDateChip
  dayOfMonth={{
    id: '1',
...
>
  ...
  {/snippet}
</CalendarDateChip>`}}}),i(v,m),w()}g.__docgen={data:[],name:"Customize.stories.svelte"};const M=S(g,H),et=["CustomCalendarDateChipContent","CustomCalendarDateChip"],at={...M.CustomCalendarDateChipContent,tags:["svelte-csf-v5"]},ot={...M.CustomCalendarDateChip,tags:["svelte-csf-v5"]};export{ot as CustomCalendarDateChip,at as CustomCalendarDateChipContent,et as __namedExportsOrder,H as default};
