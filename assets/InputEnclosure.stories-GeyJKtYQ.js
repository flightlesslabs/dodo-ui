import{n as e}from"./chunk-BneVvdWh.js";import{J as t,dt as n,j as r,k as i,q as a,t as o,ut as s,wt as c}from"./client-D_tSG6NS.js";import{F as l,S as u,at as d,c as f,it as p,n as m,r as h,t as g,u as _}from"./create-runtime-stories-BVDA5393.js";function v(e,r){n(r,!0);var o=F(),c=a(o);S(c,{name:`Default`,children:(e,t)=>{i(e,C())},$$slots:{default:!0},parameters:{docs:{description:{story:`------------------------------`}},__svelteCsf:{rawCode:`<InputEnclosure {...args}>
  <input placeholder="Type something…" class="InputBox" />
</InputEnclosure>`}}});var d=t(c,2);S(d,{name:`No Outline`,args:{outline:!1},children:(e,t)=>{i(e,w())},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<InputEnclosure {...args}>
  <input placeholder="No outline…" class="InputBox" />
</InputEnclosure>`}}});var f=t(d,2);S(f,{name:`Focused`,args:{focused:!0},children:(e,t)=>{i(e,T())},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<InputEnclosure {...args}>
  <input placeholder="Focused state…" class="InputBox" />
</InputEnclosure>`}}});var p=t(f,2);S(p,{name:`Error`,args:{error:!0},children:(e,t)=>{i(e,E())},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<InputEnclosure {...args}>
  <input placeholder="Error state…" class="InputBox" />
</InputEnclosure>`}}});var m=t(p,2);S(m,{name:`Disabled`,args:{disabled:!0},children:(e,t)=>{i(e,D())},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<InputEnclosure {...args}>
  <input placeholder="Disabled state…" disabled class="InputBox" />
</InputEnclosure>`}}});var h=t(m,2);S(h,{name:`Large`,args:{size:`large`},children:(e,t)=>{i(e,O())},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<InputEnclosure {...args}>
  <input placeholder="Large input…" class="InputBox" />
</InputEnclosure>`}}});var g=t(h,2);S(g,{name:`With Before (Icon Prefix)`,asChild:!0,children:(e,t)=>{l(e,{before:e=>{i(e,k())},children:(e,t)=>{i(e,A())},$$slots:{before:!0,default:!0}})},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<InputEnclosure>
  {#snippet before()}
    <span style="color: #888; padding-left: 8px">🔍</span>
  {/snippet}

  <input placeholder="Search…" class="InputBox" />
</InputEnclosure>`}}});var _=t(g,2);S(_,{name:`With After (Suffix Text)`,asChild:!0,children:(e,t)=>{l(e,{after:e=>{i(e,j())},children:(e,t)=>{i(e,M())},$$slots:{after:!0,default:!0}})},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<InputEnclosure>
  {#snippet after()}
    <span style="color: #888; padding-right: 8px">.com</span>
  {/snippet}

  <input placeholder="Website" class="InputBox" />
</InputEnclosure>`}}});var v=t(_,2);S(v,{name:`Light Theme`,asChild:!0,children:(e,t)=>{u(e,{type:`light`,children:(e,t)=>{l(e,{children:(e,t)=>{i(e,N())},$$slots:{default:!0}})},$$slots:{default:!0}})},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<Theme type="light">
  <InputEnclosure>
    <input placeholder="Type something…" class="InputBox" />
  </InputEnclosure>
</Theme>`}}}),S(t(v,2),{name:`Dark Theme`,asChild:!0,globals:{backgrounds:{value:`dark`}},children:(e,t)=>{u(e,{type:`dark`,children:(e,t)=>{l(e,{children:(e,t)=>{i(e,P())},$$slots:{default:!0}})},$$slots:{default:!0}})},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<Theme type="dark">
  <InputEnclosure>
    <input placeholder="Type something…" class="InputBox" />
  </InputEnclosure>
</Theme>`}}}),i(e,o),s()}var y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q;e((()=>{c(),d(),h(),o(),m(),y=`
