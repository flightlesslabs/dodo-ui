import{p as J,f as C,a as P,j as f,t as n,b as t,g as _,k as K,u as A,s as c,n as N,c as Q,C as U,D as V,e as E,h as L}from"./iframe-CfBVIw1X.js";import{c as Z,d as ee}from"./create-runtime-stories-Dw7ELUXC.js";import{P as v}from"./Popper-D4hX8Dt5.js";import"./getMoment-BCHbvRiR.js";import{B as T}from"./Button-Dv_00KaB.js";import{M}from"./Menu-D_a-yPV8.js";import{M as d}from"./MenuItem-CZWVrw_-.js";import{p as te,a as oe}from"./position-CdGfDFyh.js";import"./attributes-Bsk4O1Lh.js";import"./this-ZRJxfvwF.js";import"./style-BGhvvo8Y.js";import"./Paper-tYc1JEr8.js";import"./colors-C3b1rS-d.js";const re={popupPositionX:{control:{type:"select"},options:oe},popupPositionY:{control:{type:"select"},options:te}},se={component:v,tags:["autodocs"],argTypes:re,parameters:{docs:{story:{height:"200px",inline:!1},description:{component:""}}}},{Story:g}=ee();let $=K(!1);var ne=C("<!> <!> <!>",1),pe=C("<!> <!> <!>",1),le=C("<!> <!> <!>",1),ue=C("<!> <!> <!>",1),ae=C("<!> <!> <!>",1),ie=C("<!> <!>",1),de=C("<!> <!> <!> <!> <!> <!>",1);function S(X,Y){J(Y,!0);var F=de(),W=P(F);const j=A(()=>({open:_($),onClickOutside:()=>f($,!1)}));g(W,{name:"Default",get args(){return _(j)},asChild:!0,children:(h,x)=>{v(h,{get open(){return _($)},onClickOutside:()=>f($,!1),popupChildren:s=>{M(s,{children:(u,l)=>{var p=ne(),r=P(p);d(r,{children:(o,i)=>{var e=n("One");t(o,e)},$$slots:{default:!0}});var a=c(r,2);d(a,{children:(o,i)=>{var e=n("Two");t(o,e)},$$slots:{default:!0}});var m=c(a,2);d(m,{children:(o,i)=>{var e=n("Three");t(o,e)},$$slots:{default:!0}}),t(u,p)},$$slots:{default:!0}})},children:(s,u)=>{T(s,{onclick:()=>f($,!0),children:(l,p)=>{var r=n("Click to see Popup");t(l,r)},$$slots:{default:!0}})},$$slots:{popupChildren:!0,default:!0}})},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<Popper {open} onClickOutside={() => (open = false)}>
