import{n as e}from"./chunk-DnJy8xQt.js";import{Mt as t,Ot as n,V as r,W as i,bt as a,f as o,it as s,rt as ee,yt as c,z as l}from"./iframe-Dk_IlVVN.js";import{A as u,F as d,i as f,j as p,n as m,o as h,r as g,t as _,v,z as y}from"./create-runtime-stories-3zxUgWUA.js";function b(e,t){a(t,!0);var r=z(),o=ee(r);w(o,{name:`Default`,children:(e,t)=>{l(e,T())},$$slots:{default:!0},parameters:{docs:{description:{story:`------------------------------`}},__svelteCsf:{rawCode:`<InputEnclosure {...args}>
...
</InputEnclosure>`}}});var f=s(u,2);w(f,{name:`Focused`,args:{focused:!0},children:(e,t)=>{l(e,D())},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<InputEnclosure {...args}>
...
</InputEnclosure>`}}});var m=s(p,2);w(m,{name:`Disabled`,args:{disabled:!0},children:(e,t)=>{l(e,k())},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<InputEnclosure {...args}>
  <input placeholder="Disabled state…" disabled class="InputBox" />
</InputEnclosure>`}}});var h=s(m,2);w(h,{name:`Large`,args:{size:`large`},children:(e,t)=>{l(e,A())},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<InputEnclosure {...args}>
  <input placeholder="Large input…" class="InputBox" />
</InputEnclosure>`}}});var g=s(h,2);w(g,{name:`With Before (Icon Prefix)`,asChild:!0,children:(e,t)=>{y(e,{before:e=>{l(e,j())},children:(e,t)=>{l(e,M())},$$slots:{before:!0,default:!0}})},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<InputEnclosure>
  {#snippet before()}
    <span style="color: #888; padding-left: 8px">🔍</span>
  {/snippet}

  <input placeholder="Search…" class="InputBox" />
</InputEnclosure>`}}});var _=s(g,2);w(_,{name:`With After (Suffix Text)`,asChild:!0,children:(e,t)=>{y(e,{after:e=>{l(e,N())},children:(e,t)=>{l(e,P())},$$slots:{after:!0,default:!0}})},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<InputEnclosure>
  {#snippet after()}
    <span style="color: #888; padding-right: 8px">.com</span>
  {/snippet}

  <input placeholder="Website" class="InputBox" />
</InputEnclosure>`}}});var b=s(_,2);w(b,{name:`Affix Spacing Before`,asChild:!0,children:(e,t)=>{y(e,{affixSpacingBefore:`tight`,before:e=>{d(e,{compact:!0,roundness:`full`,children:(e,t)=>{n(),l(e,i(`🔍`))},$$slots:{default:!0}})},children:(e,t)=>{l(e,F())},$$slots:{before:!0,default:!0}})},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<InputEnclosure affixSpacingBefore="tight">
  {#snippet before()}
    <UtilityButton compact roundness="full">🔍</UtilityButton>
  {/snippet}

  <input placeholder="Search…" class="InputBox" />
</InputEnclosure>`}}});var x=s(b,2);w(x,{name:`Affix Spacing After`,asChild:!0,children:(e,t)=>{y(e,{affixSpacingAfter:`tight`,after:e=>{d(e,{compact:!0,roundness:`full`,children:(e,t)=>{n(),l(e,i(`🔍`))},$$slots:{default:!0}})},children:(e,t)=>{l(e,I())},$$slots:{after:!0,default:!0}})},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<InputEnclosure affixSpacingAfter="tight">
  {#snippet after()}
    <UtilityButton compact roundness="full">🔍</UtilityButton>
  {/snippet}

  <input placeholder="Search…" class="InputBox" />
</InputEnclosure>`}}});var S=s(x,2);w(S,{name:`Light Theme`,asChild:!0,children:(e,t)=>{v(e,{type:`light`,children:(e,t)=>{y(e,{children:(e,t)=>{l(e,L())},$$slots:{default:!0}})},$$slots:{default:!0}})},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<Theme type="light">
  <InputEnclosure>
    <input placeholder="Type something…" class="InputBox" />
  </InputEnclosure>
</Theme>`}}}),w(s(S,2),{name:`Dark Theme`,asChild:!0,globals:{backgrounds:{value:`dark`}},children:(e,t)=>{v(e,{type:`dark`,children:(e,t)=>{y(e,{children:(e,t)=>{l(e,R())},$$slots:{default:!0}})},$$slots:{default:!0}})},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<Theme type="dark">
  <InputEnclosure>
    <input placeholder="Type something…" class="InputBox" />
  </InputEnclosure>
</Theme>`}}}),l(e,r),c()}var x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{t(),f(),h(),o(),m(),x=`
