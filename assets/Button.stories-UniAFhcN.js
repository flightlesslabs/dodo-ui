import{n as e}from"./chunk-BneVvdWh.js";import{A as t,Ct as n,K as r,N as i,O as a,lt as o,q as s,t as c,ut as l,vt as u}from"./client-r4VzY-6C.js";import{C as d,M as f,N as p,P as m,b as h,n as g,r as _,t as v,v as y,w as b,y as x}from"./create-runtime-stories-CP4zndj_.js";function S(e,t){l(t,!0);var n=D(),c=r(n);E(c,{name:`Default`,children:(e,t)=>{u(),a(e,i(`Click me!`))},$$slots:{default:!0},parameters:{docs:{description:{story:`------------------------------`}},__svelteCsf:{rawCode:`<Button {...args}>
  Click me!
</Button>`}}});var d=s(c,2);E(d,{name:`Link Button`,args:{href:`https://www.w3schools.com/tags/tag_a.asp`,target:`_blank`},children:(e,t)=>{u(),a(e,i(`Click me!`))},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<Button {...args}>
  Click me!
</Button>`}}});var p=s(d,2);E(p,{name:`OnClick (Actions)`,args:{onclick:e=>{let t=e.target;alert(`Button Clicked`),console.log(`Button Clicked`,t)}},children:(e,t)=>{u(),a(e,i(`Click me`))},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<Button {...args}>
  Click me
  ...
  Click me!
</Button>`}}});var g=s(h,2);E(g,{name:`Outline`,args:{variant:`text`,outline:!0},children:(e,t)=>{u(),a(e,i(`Click me!`))},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<Button {...args}>
  Click me!
</Button>`}}});var _=s(g,2);E(_,{name:`Size`,args:{size:`large`},children:(e,t)=>{u(),a(e,i(`Click me!`))},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<Button {...args}>
  Click me!
</Button>`}}});var v=s(_,2);E(v,{name:`Disabled`,args:{disabled:!0},children:(e,t)=>{u(),a(e,i(`Click me!`))},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<Button {...args}>
  Click me!
</Button>`}}});var y=s(v,2);E(y,{name:`Submit Button`,args:{type:`submit`},children:(e,t)=>{u(),a(e,i(`Click me!`))},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<Button {...args}>
  Click me!
</Button>`}}});var x=s(y,2);E(x,{name:`Full Width`,args:{fullWidth:!0},children:(e,t)=>{u(),a(e,i(`Click me!`))},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<Button {...args}>
  Click me!
