import{n as e}from"./chunk-DnJy8xQt.js";import{Pt as t,V as n,W as r,at as i,bt as a,f as o,it as s,kt as c,xt as l,z as u}from"./iframe-xlnz60GK.js";import{L as d,M as f,N as p,i as m,j as h,n as g,o as _,r as v,t as y,v as b}from"./create-runtime-stories-Gb8E1ZlD.js";function x(e,t){l(t,!0);var n=E(),o=s(n);T(o,{name:`Default`,children:(e,t)=>{c(),u(e,r(`Click me!`))},$$slots:{default:!0},parameters:{docs:{description:{story:`------------------------------`}},__svelteCsf:{rawCode:`<UtilityButton {...args}>
  Click me!
</UtilityButton>`}}});var f=i(o,2);T(f,{name:`Link Button`,args:{href:`https://www.w3schools.com/tags/tag_a.asp`,target:`_blank`},children:(e,t)=>{c(),u(e,r(`Click me!`))},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<UtilityButton {...args}>
  Click me!
</UtilityButton>`}}});var p=i(f,2);T(p,{name:`OnClick (Actions)`,args:{onclick:e=>{let t=e.target;alert(`Button Clicked`),console.log(`Button Clicked`,t)}},children:(e,t)=>{c(),u(e,r(`Click me`))},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<UtilityButton {...args}>
  Click me
  ...
  +
</UtilityButton>`}}});var x=i(y,2);T(x,{name:`Light Theme`,asChild:!0,children:(e,t)=>{b(e,{type:`light`,children:(e,t)=>{d(e,{children:(e,t)=>{c(),u(e,r(`Click me!`))},$$slots:{default:!0}})},$$slots:{default:!0}})},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<Theme type="light">
  <UtilityButton>Click me!</UtilityButton>
</Theme>`}}}),T(i(x,2),{name:`Dark Theme`,asChild:!0,globals:{backgrounds:{value:`dark`}},children:(e,t)=>{b(e,{type:`dark`,children:(e,t)=>{d(e,{children:(e,t)=>{c(),u(e,r(`Click me!`))},$$slots:{default:!0}})},$$slots:{default:!0}})},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<Theme type="dark">
  <UtilityButton>Click me!</UtilityButton>
