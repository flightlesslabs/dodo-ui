import{n as e}from"./chunk-DnJy8xQt.js";import{Mt as t,Ot as n,V as r,W as i,bt as a,ct as o,f as s,it as c,q as l,rt as u,ut as d,yt as f,z as p}from"./iframe-CANpI-uB.js";import{E as m,O as h,i as g,j as _,n as v,o as y,r as b,t as x,v as S,w as C}from"./create-runtime-stories-C72NYMsm.js";import{o as w,t as T}from"./dist-C_V1QCZT.js";function E(e,t){a(t,!0);var r=M(),s=u(r);A(s,{name:`Default`,args:{id:`Default`},children:(e,t)=>{n(),p(e,i(`Check this text`))},$$slots:{default:!0},parameters:{docs:{description:{story:`------------------------------`}},__svelteCsf:{rawCode:`<Checkbox {...args}>
  Check this text
  ...
  Check this text
</Checkbox>`}}});var x=c(b,2);A(x,{name:`Light Theme`,asChild:!0,children:(e,t)=>{S(e,{type:`light`,children:(e,t)=>{w(e,{id:`Light_Theme`,children:(e,t)=>{n(),p(e,i(`Check this text`))},$$slots:{default:!0}})},$$slots:{default:!0}})},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<Theme type="light">
  <Checkbox id="Light_Theme">Check this text</Checkbox>
</Theme>`}}}),A(c(x,2),{name:`Dark Theme`,asChild:!0,globals:{backgrounds:{value:`dark`}},children:(e,t)=>{S(e,{type:`dark`,children:(e,t)=>{w(e,{id:`Dark_Theme`,children:(e,t)=>{n(),p(e,i(`Check this text`))},$$slots:{default:!0}})},$$slots:{default:!0}})},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<Theme type="dark">
  <Checkbox id="Dark_Theme">Check this text</Checkbox>
</Theme>`}}}),p(e,r),f()}var D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G;e((()=>{t(),g(),y(),T(),s(),v(),D=`
