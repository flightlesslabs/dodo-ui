import{n as e}from"./chunk-DnJy8xQt.js";import{Nt as t,V as n,W as r,at as i,bt as a,dt as o,f as s,it as c,kt as l,lt as u,q as d,xt as f,z as p}from"./iframe-BqkSn_Jh.js";import{A as m,F as h,M as g,O as _,i as v,n as y,o as b,r as x,t as S,v as C}from"./create-runtime-stories-DyyPz2dT.js";import{r as w,t as T}from"./dist-CbcjyIpk.js";function E(e,t){f(t,!0);var n=M(),o=c(n);A(o,{name:`Default`,args:{id:`Default`},children:(e,t)=>{l(),p(e,r(`Check this text`))},$$slots:{default:!0},parameters:{docs:{description:{story:`------------------------------`}},__svelteCsf:{rawCode:`<Switch {...args}>
  Check this text
  ...
  Check this text
</Switch>`}}});var v=i(_,2);A(v,{name:`Large`,args:{id:`Large`,size:`large`},children:(e,t)=>{l(),p(e,r(`Check this text`))},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<Switch {...args}>
  Check this text
</Switch>`}}});var y=i(v,2);A(y,{name:`Disabled`,args:{disabled:!0},children:(e,t)=>{l(),p(e,r(`Check this text`))},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<Switch {...args}>
  Check this text
</Switch>`}}});var b=i(y,2);A(b,{name:`Light Theme`,asChild:!0,children:(e,t)=>{C(e,{type:`light`,children:(e,t)=>{w(e,{id:`Light_Theme`,children:(e,t)=>{l(),p(e,r(`Check this text`))},$$slots:{default:!0}})},$$slots:{default:!0}})},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<Theme type="light">
  <Switch id="Light_Theme">Check this text</Switch>
</Theme>`}}}),A(i(b,2),{name:`Dark Theme`,asChild:!0,globals:{backgrounds:{value:`dark`}},children:(e,t)=>{C(e,{type:`dark`,children:(e,t)=>{w(e,{id:`Dark_Theme`,children:(e,t)=>{l(),p(e,r(`Check this text`))},$$slots:{default:!0}})},$$slots:{default:!0}})},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<Theme type="dark">
  <Switch id="Dark_Theme">Check this text</Switch>
</Theme>`}}}),p(e,n),a()}var D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W;e((()=>{t(),v(),b(),T(),s(),y(),D=`
