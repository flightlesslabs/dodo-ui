import{i as e}from"./preload-helper-xPQekRTU.js";import{$t as t,Ht as n,Q as r,St as i,Ut as a,et as o,f as s,g as c,gt as l,ln as u,nt as d,ot as f,tn as p,wt as m}from"./iframe-CP3e54cT.js";import{G as h,H as g,K as _,Q as v,dt as y,ht as b,mt as x,n as S,r as C,t as w}from"./create-runtime-stories-K5EB4XPM.js";import{a as T,n as E,o as D,t as O}from"./dist-CwVdvW70.js";function k(e,s){a(s,!0);var u=L(),d=i(u);M(d,{name:`Default`,asChild:!0,children:(e,n)=>{var r=N(),a=i(r);y(a,{onclick:()=>{T.add({title:`Toast`,description:`This is a basic toast.`,color:`danger`})},children:(e,n)=>{t(),o(e,f(`Add Toast`))},$$slots:{default:!0}}),E(m(a,2),{}),o(e,r)},$$slots:{default:!0},parameters:{docs:{description:{story:`------------------------------`}},__svelteCsf:{rawCode:`<Button
  onclick={() => {
    toasts.add({
      title: 'Toast',
