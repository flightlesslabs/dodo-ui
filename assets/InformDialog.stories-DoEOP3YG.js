...
>
  This is a basic InformDialog with a title and a single action.
</InformDialog>`}}});var g=a(c,2);j(g,{name:`Custom Accept Button`,asChild:!0,children:(e,t)=>{var n=B(),r=l(n);v(r,{onclick:()=>d(P,!0),children:(e,t)=>{u(),h(e,i(`Open`))},$$slots:{default:!0}}),w(a(r,2),{title:`Inform Dialog title`,get open(){return f(P)},set open(e){d(P,e,!0)},customAcceptButton:e=>{v(e,{compact:!0,onclick:()=>d(P,!1),children:(e,t)=>{u(),h(e,i(`👍`))},$$slots:{default:!0}})},children:(e,t)=>{u(),h(e,i(`This is a basic InformDialog with a title and a single action.`))},$$slots:{customAcceptButton:!0,default:!0}}),h(e,n)},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<Button onclick={() => (openCustomAcceptButton = true)}>Open</Button>
...
<InformDialog bind:open={openCustomModalcard}>
  ...
  {/snippet}
</InformDialog>`}}}),h(e,r),o()}var O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{n(),g(),x(),T(),c(),b(),O=`
