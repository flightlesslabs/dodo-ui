import{n as e}from"./chunk-BneVvdWh.js";import{A as t,Ct as n,K as r,O as i,lt as a,q as o,t as s,ut as c}from"./client-Bd_pqFlz.js";import{M as l,S as u,c as d,j as f,k as p,n as m,r as h,t as g,u as _}from"./create-runtime-stories-XdMiYN-8.js";function v(e,t){c(t,!0);var n=F(),s=r(n);S(s,{name:`Default`,children:(e,t)=>{i(e,C())},$$slots:{default:!0},parameters:{docs:{description:{story:`------------------------------`}},__svelteCsf:{rawCode:`<InputEnclosure {...args}>
  <input placeholder="Type something…" class="InputBox" />
</InputEnclosure>`}}});var l=o(s,2);S(l,{name:`No Outline`,args:{outline:!1},children:(e,t)=>{i(e,w())},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<InputEnclosure {...args}>
  <input placeholder="No outline…" class="InputBox" />
</InputEnclosure>`}}});var d=o(l,2);S(d,{name:`Focused`,args:{focused:!0},children:(e,t)=>{i(e,T())},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<InputEnclosure {...args}>
...
</InputEnclosure>`}}});var m=o(f,2);S(m,{name:`Disabled`,args:{disabled:!0},children:(e,t)=>{i(e,D())},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<InputEnclosure {...args}>
...
</InputEnclosure>`}}});var g=o(h,2);S(g,{name:`With Before (Icon Prefix)`,asChild:!0,children:(e,t)=>{p(e,{before:e=>{i(e,k())},children:(e,t)=>{i(e,A())},$$slots:{before:!0,default:!0}})},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<InputEnclosure>
  {#snippet before()}
    <span style="color: #888; padding-left: 8px">🔍</span>
  {/snippet}

  <input placeholder="Search…" class="InputBox" />
</InputEnclosure>`}}});var _=o(g,2);S(_,{name:`With After (Suffix Text)`,asChild:!0,children:(e,t)=>{p(e,{after:e=>{i(e,j())},children:(e,t)=>{i(e,M())},$$slots:{after:!0,default:!0}})},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<InputEnclosure>
  {#snippet after()}
    <span style="color: #888; padding-right: 8px">.com</span>
  {/snippet}

  <input placeholder="Website" class="InputBox" />
</InputEnclosure>`}}});var v=o(_,2);S(v,{name:`Light Theme`,asChild:!0,children:(e,t)=>{u(e,{type:`light`,children:(e,t)=>{p(e,{children:(e,t)=>{i(e,N())},$$slots:{default:!0}})},$$slots:{default:!0}})},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<Theme type="light">
  <InputEnclosure>
    <input placeholder="Type something…" class="InputBox" />
  </InputEnclosure>
</Theme>`}}}),S(o(v,2),{name:`Dark Theme`,asChild:!0,globals:{backgrounds:{value:`dark`}},children:(e,t)=>{u(e,{type:`dark`,children:(e,t)=>{p(e,{children:(e,t)=>{i(e,P())},$$slots:{default:!0}})},$$slots:{default:!0}})},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<Theme type="dark">
  <InputEnclosure>
    <input placeholder="Type something…" class="InputBox" />
  </InputEnclosure>
</Theme>`}}}),i(e,n),a()}var y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q;e((()=>{n(),l(),h(),s(),m(),y=`
