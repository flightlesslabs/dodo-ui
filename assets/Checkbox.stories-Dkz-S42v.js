import{n as e}from"./chunk-DnJy8xQt.js";import{Nt as t,V as n,W as r,at as i,bt as a,dt as o,f as s,it as c,kt as l,lt as u,q as d,xt as f,z as p}from"./iframe-B0th9W7o.js";import{A as m,F as h,M as g,O as _,i as v,n as y,o as b,r as x,t as S,v as C}from"./create-runtime-stories-DEf2rZCM.js";import{o as w,t as T}from"./dist-DEd6gyz9.js";function E(e,t){f(t,!0);var n=M(),o=c(n);A(o,{name:`Default`,args:{id:`Default`},children:(e,t)=>{l(),p(e,r(`Check this text`))},$$slots:{default:!0},parameters:{docs:{description:{story:`------------------------------`}},__svelteCsf:{rawCode:`<Checkbox {...args}>
  Check this text
  ...
  Check this text
</Checkbox>`}}});var b=i(y,2);A(b,{name:`Disabled`,args:{disabled:!0},children:(e,t)=>{l(),p(e,r(`Check this text`))},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<Checkbox {...args}>
  Check this text
</Checkbox>`}}});var x=i(b,2);A(x,{name:`Light Theme`,asChild:!0,children:(e,t)=>{C(e,{type:`light`,children:(e,t)=>{w(e,{id:`Light_Theme`,children:(e,t)=>{l(),p(e,r(`Check this text`))},$$slots:{default:!0}})},$$slots:{default:!0}})},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<Theme type="light">
  <Checkbox id="Light_Theme">Check this text</Checkbox>
</Theme>`}}}),A(i(x,2),{name:`Dark Theme`,asChild:!0,globals:{backgrounds:{value:`dark`}},children:(e,t)=>{C(e,{type:`dark`,children:(e,t)=>{w(e,{id:`Dark_Theme`,children:(e,t)=>{l(),p(e,r(`Check this text`))},$$slots:{default:!0}})},$$slots:{default:!0}})},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<Theme type="dark">
  <Checkbox id="Dark_Theme">Check this text</Checkbox>
</Theme>`}}}),p(e,n),a()}var D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G;e((()=>{t(),v(),b(),T(),s(),y(),D=`
