import{p as z,f as g,a as v,j as f,t as r,b as e,g as _,k as G,u as H,s as c,n as J,c as K,E as N,F as Q,e as A,h as L}from"./iframe-Dm2oeldt.js";import{c as U,d as V}from"./create-runtime-stories-DwmOa5kD.js";import{P as M}from"./Popper-BTA-ov8j.js";import"./getMoment-DtA9pdSi.js";import{B as T}from"./Button-Dnq_sH0K.js";import{M as I}from"./Menu-q_TH3IYq.js";import{M as d}from"./MenuItem-DlUHDrj0.js";import{p as Z,a as ee}from"./position-CdGfDFyh.js";import"./attributes-CLo3BtRJ.js";import"./this-5OZYxuTc.js";import"./style-C9bfH9eW.js";import"./Paper-DZtFFZ_D.js";import"./colors-C3b1rS-d.js";const te={popupPositionX:{control:{type:"select"},options:ee},popupPositionY:{control:{type:"select"},options:Z}},oe={component:M,tags:["autodocs"],argTypes:te,parameters:{docs:{story:{height:"200px",inline:!1},description:{component:""}}}},{Story:x}=V();let $=G(!1);var re=g("<!> <!> <!>",1),se=g("<!> <!> <!>",1),ne=g("<!> <!> <!>",1),pe=g("<!> <!> <!>",1),le=g("<!> <!> <!>",1),ue=g("<!> <!>",1),ae=g("<!> <!> <!> <!> <!> <!>",1);function S(X,Y){z(Y,!0);var F=ae(),W=v(F);{let m=H(()=>({open:_($),onClickOutside:()=>f($,!1)}));x(W,{name:"Default",get args(){return _(m)},asChild:!0,children:(C,O)=>{M(C,{get open(){return _($)},onClickOutside:()=>f($,!1),popupChildren:l=>{I(l,{children:(u,n)=>{var s=re(),p=v(s);d(p,{children:(a,t)=>{var P=r("One");e(a,P)},$$slots:{default:!0}});var h=c(p,2);d(h,{children:(a,t)=>{var P=r("Two");e(a,P)},$$slots:{default:!0}});var o=c(h,2);d(o,{children:(a,t)=>{var P=r("Three");e(a,P)},$$slots:{default:!0}}),e(u,s)},$$slots:{default:!0}})},children:(l,u)=>{T(l,{onclick:()=>f($,!0),children:(n,s)=>{var p=r("Click to see Popup");e(n,p)},$$slots:{default:!0}})},$$slots:{popupChildren:!0,default:!0}})},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<Popper {open} onClickOutside={() => (open = false)}>
