...
>
  This is a basic InformDialog with a title and a single action.
</InformDialog>`}}});var g=a(c,2);j(g,{name:`Custom Accept Button`,asChild:!0,children:(e,t)=>{var n=B(),r=l(n);C(r,{onclick:()=>d(P,!0),children:(e,t)=>{u(),h(e,i(`Open`))},$$slots:{default:!0}}),w(a(r,2),{title:`Inform Dialog title`,get open(){return f(P)},set open(e){d(P,e,!0)},customAcceptButton:e=>{C(e,{compact:!0,onclick:()=>d(P,!1),children:(e,t)=>{u(),h(e,i(`👍`))},$$slots:{default:!0}})},children:(e,t)=>{u(),h(e,i(`This is a basic InformDialog with a title and a single action.`))},$$slots:{customAcceptButton:!0,default:!0}}),h(e,n)},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<Button onclick={() => (openCustomAcceptButton = true)}>Open</Button>
...
<InformDialog bind:open={openCustomModalcard}>
  ...
  {/snippet}
</InformDialog>`}}}),h(e,r),o()}var O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{n(),v(),x(),E(),c(),y(),O=`
...
## ✨ Usage
 ...
 `,k={class:{table:{category:`API`,subcategory:`Base`}},clearOnAccept:{control:{type:`boolean`},table:{category:`API`,subcategory:`Base`,defaultValue:{summary:`true`}}},clearable:{control:{type:`boolean`},table:{category:`API`,subcategory:`Base`}},controlsAlignment:{control:{type:`select`},options:_,table:{category:`API`,subcategory:`Base`,defaultValue:{summary:`end`}}},title:{table:{category:`API`,subcategory:`Base`}},customTitle:{table:{category:`API`,subcategory:`Slots`}},customModalCard:{table:{category:`API`,subcategory:`Slots`}}},A={component:w,tags:[`autodocs`],argTypes:k,parameters:{layout:`fullscreen`,docs:{description:{component:O}}}},{Story:j}=g(A),M=s(!1),N=s(!1),P=s(!1),F=s(!1),I=s(!1),L=s(!1),R=r(`<!> <!>`,1),z=r(`<!> <!>`,1),B=r(`<!> <!>`,1),V=r(`<!> <!>`,1),H=r(`<!> <!>`,1),U=r(`<div style="display: flex; flex-direction: column; gap: 12px;"><!> <!></div>`),W=r(`<!> <!>`,1),G=r(`<!> <!> <!> <!> <!> <!>`,1),D.__docgen={data:[],name:`InformDialog.stories.svelte`},K=S(D,A),q=[`Default`,`AcceptButtonProps`,`CustomAcceptButton`,`ControlsAlignment`,`CustomTitle`,`CustomModalCard`],J={...K.Default,tags:[`svelte-csf-v5`]},Y={...K.AcceptButtonProps,tags:[`svelte-csf-v5`]},X={...K.CustomAcceptButton,tags:[`svelte-csf-v5`]},Z={...K.ControlsAlignment,tags:[`svelte-csf-v5`]},Q={...K.CustomTitle,tags:[`svelte-csf-v5`]},$={...K.CustomModalCard,tags:[`svelte-csf-v5`]}}))();export{Y as AcceptButtonProps,Z as ControlsAlignment,X as CustomAcceptButton,$ as CustomModalCard,Q as CustomTitle,J as Default,q as __namedExportsOrder,A as default,k as storyInformDialogArgTypes};