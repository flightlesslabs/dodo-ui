import{n as e}from"./chunk-BneVvdWh.js";import{A as t,Ct as n,K as r,N as i,O as a,lt as o,q as s,t as c,ut as l,vt as u}from"./client-Bd_pqFlz.js";import{A as d,M as f,S as p,c as m,j as h,n as g,r as _,s as v,t as y,u as b,x}from"./create-runtime-stories-XdMiYN-8.js";function S(e,t){l(t,!0);var n=D(),c=r(n);E(c,{name:`Default`,children:(e,t)=>{u(),a(e,i(`Click me!`))},$$slots:{default:!0},parameters:{docs:{description:{story:`------------------------------`}},__svelteCsf:{rawCode:`<Button {...args}>
  Click me!
  ...
  Click me!
</Button>`}}});var m=s(f,2);E(m,{name:`OnClick (Actions)`,args:{onclick:e=>{let t=e.target;alert(`Button Clicked`),console.log(`Button Clicked`,t)}},children:(e,t)=>{u(),a(e,i(`Click me`))},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<Button {...args}>
  Click me
</Button>`}}});var h=s(m,2);E(h,{name:`Color`,args:{color:`safe`},children:(e,t)=>{u(),a(e,i(`Click me`))},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<Button {...args}>
  Click me
</Button>`}}});var g=s(h,2);E(g,{name:`Text`,args:{variant:`text`},children:(e,t)=>{u(),a(e,i(`Click me!`))},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<Button {...args}>
  Click me!
</Button>`}}});var _=s(g,2);E(_,{name:`Outline`,args:{variant:`text`,outline:!0},children:(e,t)=>{u(),a(e,i(`Click me!`))},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<Button {...args}>
  Click me!
