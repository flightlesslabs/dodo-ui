...
<Modal bind:open={openCustomTitle}>
  ...
  {/snippet}
</Modal>`}}}),j(a(g,2),{name:`Custom Modal Card`,asChild:!0,children:(e,n)=>{var r=H(),o=l(r);_(o,{onclick:()=>d(F,!0),children:(e,t)=>{u(),h(e,i(`Open`))},$$slots:{default:!0}}),w(a(o,2),{get open(){return f(F)},set open(e){d(F,e,!0)},customModalCard:e=>{T(e,{onclear:()=>d(F,!1),children:(e,n)=>{var r=V(),o=p(r);x(o,{children:(e,t)=>{u(),h(e,i(`Delete Item`))},$$slots:{default:!0}});var s=a(o,2);x(s,{children:(e,t)=>{u(),h(e,i(`Are you sure you want to delete this item? This action cannot be undone.`))},$$slots:{default:!0}});var c=a(s,2),l=p(c);_(l,{onclick:()=>d(F,!1),children:(e,t)=>{u(),h(e,i(`Cancel`))},$$slots:{default:!0}}),_(a(l,2),{color:`danger`,onclick:()=>d(F,!1),children:(e,t)=>{u(),h(e,i(`Delete`))},$$slots:{default:!0}}),t(c),t(r),h(e,r)},$$slots:{default:!0}})},$$slots:{customModalCard:!0}}),h(e,r)},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<Button onclick={() => (openCustomModalcard = true)}>Open</Button>
...
<Modal bind:open={openCustomModalcard}>
  ...
  {/snippet}
</Modal>`}}}),h(e,r),o()}var O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y;e((()=>{n(),y(),S(),E(),c(),b(),O=`
