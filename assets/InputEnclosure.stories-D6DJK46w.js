import{n as e}from"./chunk-DnJy8xQt.js";import{It as t,V as n,W as r,at as i,bt as ee,f as a,it as o,kt as s,xt as c,z as l}from"./iframe-dZL2AUY8.js";import{G as u,K as d,M as f,N as p,U as m,g as h,n as g,r as _,t as v,z as y}from"./create-runtime-stories-Nh7z_9Mh.js";function b(e,t){c(t,!0);var n=z(),a=o(n);w(a,{name:`Default`,children:(e,t)=>{l(e,T())},$$slots:{default:!0},parameters:{docs:{description:{story:`------------------------------`}},__svelteCsf:{rawCode:`<InputEnclosure {...args}>
...
</InputEnclosure>`}}});var p=i(f,2);w(p,{name:`Disabled`,args:{disabled:!0},children:(e,t)=>{l(e,k())},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<InputEnclosure {...args}>
  <input placeholder="Disabled state…" disabled class="InputBox" />
</InputEnclosure>`}}});var g=i(p,2);w(g,{name:`Large`,args:{size:`large`},children:(e,t)=>{l(e,A())},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<InputEnclosure {...args}>
  <input placeholder="Large input…" class="InputBox" />
</InputEnclosure>`}}});var _=i(g,2);w(_,{name:`With Before (Icon Prefix)`,asChild:!0,children:(e,t)=>{m(e,{before:e=>{l(e,j())},children:(e,t)=>{l(e,M())},$$slots:{before:!0,default:!0}})},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<InputEnclosure>
  {#snippet before()}
    <span style="color: #888; padding-left: 8px">🔍</span>
  {/snippet}

  <input placeholder="Search…" class="InputBox" />
</InputEnclosure>`}}});var v=i(_,2);w(v,{name:`With After (Suffix Text)`,asChild:!0,children:(e,t)=>{m(e,{after:e=>{l(e,N())},children:(e,t)=>{l(e,P())},$$slots:{after:!0,default:!0}})},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<InputEnclosure>
  {#snippet after()}
    <span style="color: #888; padding-right: 8px">.com</span>
  {/snippet}

  <input placeholder="Website" class="InputBox" />
</InputEnclosure>`}}});var b=i(v,2);w(b,{name:`Affix Spacing Before`,asChild:!0,children:(e,t)=>{m(e,{affixSpacingBefore:`tight`,before:e=>{y(e,{compact:!0,roundness:`full`,children:(e,t)=>{s(),l(e,r(`🔍`))},$$slots:{default:!0}})},children:(e,t)=>{l(e,F())},$$slots:{before:!0,default:!0}})},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<InputEnclosure affixSpacingBefore="tight">
  {#snippet before()}
    <UtilityButton compact roundness="full">🔍</UtilityButton>
  {/snippet}

  <input placeholder="Search…" class="InputBox" />
</InputEnclosure>`}}});var x=i(b,2);w(x,{name:`Affix Spacing After`,asChild:!0,children:(e,t)=>{m(e,{affixSpacingAfter:`tight`,after:e=>{y(e,{compact:!0,roundness:`full`,children:(e,t)=>{s(),l(e,r(`🔍`))},$$slots:{default:!0}})},children:(e,t)=>{l(e,I())},$$slots:{after:!0,default:!0}})},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<InputEnclosure affixSpacingAfter="tight">
  {#snippet after()}
    <UtilityButton compact roundness="full">🔍</UtilityButton>
  {/snippet}

  <input placeholder="Search…" class="InputBox" />
</InputEnclosure>`}}});var S=i(x,2);w(S,{name:`Light Theme`,asChild:!0,children:(e,t)=>{h(e,{type:`light`,children:(e,t)=>{m(e,{children:(e,t)=>{l(e,L())},$$slots:{default:!0}})},$$slots:{default:!0}})},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<Theme type="light">
  <InputEnclosure>
    <input placeholder="Type something…" class="InputBox" />
  </InputEnclosure>
</Theme>`}}}),w(i(S,2),{name:`Dark Theme`,asChild:!0,globals:{backgrounds:{value:`dark`}},children:(e,t)=>{h(e,{type:`dark`,children:(e,t)=>{m(e,{children:(e,t)=>{l(e,R())},$$slots:{default:!0}})},$$slots:{default:!0}})},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<Theme type="dark">
  <InputEnclosure>
    <input placeholder="Type something…" class="InputBox" />
  </InputEnclosure>
</Theme>`}}}),l(e,n),ee()}var x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{t(),d(),_(),a(),g(),x=`
