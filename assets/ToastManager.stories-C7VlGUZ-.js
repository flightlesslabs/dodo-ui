import{n as e}from"./chunk-DnJy8xQt.js";import{$ as t,It as n,L as r,V as i,W as a,at as o,bt as s,f as c,h as l,it as u,jt as d,kt as f,xt as p,z as m}from"./iframe-BMIQX6az.js";import{A as h,E as g,I as _,K as v,W as y,k as b,n as x,q as S,r as C,t as w}from"./create-runtime-stories-CmJJFurP.js";import{i as T,n as E,r as D,t as O}from"./dist-3mTIOJhO.js";function k(e,n){p(n,!0);var i=L(),c=u(i);M(c,{name:`Default`,asChild:!0,children:(e,t)=>{var n=N(),r=u(n);y(r,{onclick:()=>{D.add({title:`Toast`,description:`This is a basic toast.`,color:`danger`})},children:(e,t)=>{f(),m(e,a(`Add Toast`))},$$slots:{default:!0}}),E(o(r,2),{}),m(e,n)},$$slots:{default:!0},parameters:{docs:{description:{story:`------------------------------`}},__svelteCsf:{rawCode:`<Button
  onclick={() => {
    toasts.add({
      title: 'Toast',
