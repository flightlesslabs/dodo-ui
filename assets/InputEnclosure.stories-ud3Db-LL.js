import{n as e}from"./chunk-DnJy8xQt.js";import{Nt as t,V as n,W as r,at as i,bt as a,f as o,it as ee,kt as s,xt as c,z as l}from"./iframe-c6W4dOLd.js";import{L as u,M as d,N as f,V as p,i as m,n as h,o as g,r as _,t as v,v as y}from"./create-runtime-stories-CBKs_xX9.js";function b(e,t){c(t,!0);var n=z(),o=ee(n);w(o,{name:`Default`,children:(e,t)=>{l(e,T())},$$slots:{default:!0},parameters:{docs:{description:{story:`------------------------------`}},__svelteCsf:{rawCode:`<InputEnclosure {...args}>
  <input placeholder="Type something…" class="InputBox" />
</InputEnclosure>`}}});var d=i(o,2);w(d,{name:`No Outline`,args:{outline:!1},children:(e,t)=>{l(e,E())},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<InputEnclosure {...args}>
  <input placeholder="No outline…" class="InputBox" />
</InputEnclosure>`}}});var f=i(d,2);w(f,{name:`Focused`,args:{focused:!0},children:(e,t)=>{l(e,D())},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<InputEnclosure {...args}>
...
</InputEnclosure>`}}});var b=i(v,2);w(b,{name:`Affix Spacing Before`,asChild:!0,children:(e,t)=>{p(e,{affixSpacingBefore:`tight`,before:e=>{u(e,{compact:!0,roundness:`full`,children:(e,t)=>{s(),l(e,r(`🔍`))},$$slots:{default:!0}})},children:(e,t)=>{l(e,F())},$$slots:{before:!0,default:!0}})},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<InputEnclosure affixSpacingBefore="tight">
  {#snippet before()}
    <UtilityButton compact roundness="full">🔍</UtilityButton>
  {/snippet}

  <input placeholder="Search…" class="InputBox" />
</InputEnclosure>`}}});var x=i(b,2);w(x,{name:`Affix Spacing After`,asChild:!0,children:(e,t)=>{p(e,{affixSpacingAfter:`tight`,after:e=>{u(e,{compact:!0,roundness:`full`,children:(e,t)=>{s(),l(e,r(`🔍`))},$$slots:{default:!0}})},children:(e,t)=>{l(e,I())},$$slots:{after:!0,default:!0}})},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<InputEnclosure affixSpacingAfter="tight">
  {#snippet after()}
    <UtilityButton compact roundness="full">🔍</UtilityButton>
  {/snippet}

  <input placeholder="Search…" class="InputBox" />
</InputEnclosure>`}}});var S=i(x,2);w(S,{name:`Light Theme`,asChild:!0,children:(e,t)=>{y(e,{type:`light`,children:(e,t)=>{p(e,{children:(e,t)=>{l(e,L())},$$slots:{default:!0}})},$$slots:{default:!0}})},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<Theme type="light">
  <InputEnclosure>
    <input placeholder="Type something…" class="InputBox" />
  </InputEnclosure>
</Theme>`}}}),w(i(S,2),{name:`Dark Theme`,asChild:!0,globals:{backgrounds:{value:`dark`}},children:(e,t)=>{y(e,{type:`dark`,children:(e,t)=>{p(e,{children:(e,t)=>{l(e,R())},$$slots:{default:!0}})},$$slots:{default:!0}})},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<Theme type="dark">
  <InputEnclosure>
    <input placeholder="Type something…" class="InputBox" />
  </InputEnclosure>
</Theme>`}}}),l(e,n),a()}var x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{t(),m(),g(),o(),h(),x=`
