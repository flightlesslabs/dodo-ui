import{n as e}from"./chunk-DnJy8xQt.js";import{Pt as t,V as n,W as r,at as i,bt as a,dt as o,f as s,it as c,kt as l,lt as u,q as d,xt as f,z as p}from"./iframe-DIJ4IwKY.js";import{A as m,B as h,N as g,O as _,T as v,V as y,h as b,n as x,r as S,t as C}from"./create-runtime-stories-DxbNeQCk.js";import{m as w,t as T}from"./dist-DlPcAZLK.js";function E(e,t){f(t,!0);var n=M(),o=c(n);A(o,{name:`Default`,args:{id:`Default`},children:(e,t)=>{l(),p(e,r(`Check this text`))},$$slots:{default:!0},parameters:{docs:{description:{story:`------------------------------`}},__svelteCsf:{rawCode:`<Checkbox {...args}>
  Check this text
...
</Theme>`}}}),p(e,n),a()}var D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G;e((()=>{t(),y(),S(),T(),s(),x(),D=`
