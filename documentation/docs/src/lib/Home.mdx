...
<img
  src="https://flightlesslabs.github.io/branding/dodo-circle-2.png"
  style={{ width: 200, height: 'auto' }}
/>

# Dodo UI

<h3 style={{ fontWeight: 400 }}>Opinionated UI framework for Svelte.</h3>
...
- [Customize](https://flightlesslabs.github.io/dodo-ui-homepage/customize)
