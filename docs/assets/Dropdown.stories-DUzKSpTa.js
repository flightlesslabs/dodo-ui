import{i as e}from"./preload-helper-CuCQULJj.js";import{Et as t,Gt as n,Q as r,Wt as i,dn as a,et as o,f as s,nt as c,ot as l,tn as u,vt as d,wt as f}from"./iframe-D-6HYk99.js";import{T as p,_t as m,n as h,r as g,t as _,vt as v}from"./create-runtime-stories-Cv_8PuEr.js";import{A as y,I as b,M as x,P as S,t as C}from"./dist-CJi74XPO.js";function w(e,a){n(a,!0);var s=j(),c=f(s);k(c,{name:`Default`,children:(e,t)=>{u(),o(e,l(`Dropdown`))},$$slots:{default:!0},parameters:{docs:{description:{story:`------------------------------`}},__svelteCsf:{rawCode:`<Dropdown {...args}>
  Dropdown
  ...
  Dropdown
</Dropdown>`}}});var g=t(h,2);k(g,{name:`Menu Item outline`,args:{menuItemProps:{outline:!0}},children:(e,t)=>{u(),o(e,l(`Dropdown`))},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<Dropdown {...args}>
  Dropdown
</Dropdown>`}}});var _=t(g,2);k(_,{name:`Button styles`,args:{triggerProps:{color:`danger`}},children:(e,t)=>{u(),o(e,l(`Dropdown`))},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<Dropdown {...args}>
  Dropdown
</Dropdown>`}}});var v=t(_,2);k(v,{name:`Menu styles`,args:{menuProps:{outline:!0,color:`primary`}},children:(e,t)=>{u(),o(e,l(`Dropdown`))},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<Dropdown {...args}>
  Dropdown
</Dropdown>`}}});var C=t(v,2);k(C,{name:`Custom Trigger`,asChild:!0,children:(e,t)=>{y(e,{get options(){return E},customTrigger:e=>{b(e,{children:(e,t)=>{u(),o(e,l(`⚡ Hello`))},$$slots:{default:!0}})},$$slots:{customTrigger:!0}})},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<Dropdown {options}>
  {#snippet customTrigger()}
    <DropdownTrigger>⚡ Hello</DropdownTrigger>
  {/snippet}
</Dropdown>`}}});var w=t(C,2);k(w,{name:`Custom Menu content`,asChild:!0,children:(e,t)=>{y(e,{get options(){return E},customMenuItemContent:(e,t)=>{let n=()=>t?.().option;u();var i=l();d(()=>r(i,`⚡${n().label??``}`)),o(e,i)},children:(e,t)=>{u(),o(e,l(`Dropdown`))},$$slots:{customMenuItemContent:!0,default:!0}})},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<Dropdown {options}>
  Dropdown

  {#snippet customMenuItemContent({ option })}
    ⚡{option.label}
  {/snippet}
</Dropdown>`}}});var T=t(w,2);k(T,{name:`Custom Dropdown Menu`,asChild:!0,children:(e,n)=>{y(e,{customMenu:e=>{S(e,{children:(e,n)=>{var r=A(),i=f(r);x(i,{children:(e,t)=>{u(),o(e,l(`Uno`))},$$slots:{default:!0}});var a=t(i,2);x(a,{children:(e,t)=>{u(),o(e,l(`Dos`))},$$slots:{default:!0}}),x(t(a,2),{children:(e,t)=>{u(),o(e,l(`Tres`))},$$slots:{default:!0}}),o(e,r)},$$slots:{default:!0}})},children:(e,t)=>{u(),o(e,l(`Dropdown`))},$$slots:{customMenu:!0,default:!0}})},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<Dropdown>
  Dropdown
  ...
  {/snippet}
</Dropdown>`}}});var D=t(T,2);k(D,{name:`Light Theme`,asChild:!0,children:(e,t)=>{p(e,{type:`light`,children:(e,t)=>{y(e,{get options(){return E},children:(e,t)=>{u(),o(e,l(`Dropdown`))},$$slots:{default:!0}})},$$slots:{default:!0}})},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<Theme type="light">
  <Dropdown {options}>Dropdown</Dropdown>
</Theme>`}}}),k(t(D,2),{name:`Dark Theme`,asChild:!0,globals:{backgrounds:{value:`dark`}},children:(e,t)=>{p(e,{type:`dark`,children:(e,t)=>{y(e,{get options(){return E},menuProps:{theme:`dark`},children:(e,t)=>{u(),o(e,l(`Dropdown`))},$$slots:{default:!0}})},$$slots:{default:!0}})},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<Theme type="dark">
  <Dropdown {options} menuProps={{ theme: 'dark' }}>Dropdown</Dropdown>
</Theme>`}}}),o(e,s),i()}var T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W;e((()=>{a(),v(),g(),C(),s(),h(),T=`
