...
</Theme>`}}}),a(e,o),r()}var T,E,D,O,k,A,j,M,N,P,F;e((()=>{i(),m(),_(),S(),f(),o(),g(),T={class:{table:{category:`API`,subcategory:`Base`}},value:{control:{type:`text`},table:{category:`API`,subcategory:`Base`}},title:{control:{type:`text`},table:{category:`API`,subcategory:`Base`}},customHeaderContent:{table:{category:`API`,subcategory:`Slots`}}},E={component:C,tags:[`autodocs`],argTypes:T,parameters:{docs:{description:{component:``}}}},{Story:D}=h(E),O=s(`<!> Item 2`,1),k=s(`<!> <!> <!> <!>`,1),w.__docgen={data:[],name:`AccordionItem.stories.svelte`},A=v(w,E),j=[`Default`,`CustomHeader`,`LightTheme`,`DarkTheme`],M={...A.Default,tags:[`svelte-csf-v5`]},N={...A.CustomHeader,tags:[`svelte-csf-v5`]},P={...A.LightTheme,tags:[`svelte-csf-v5`]},F={...A.DarkTheme,tags:[`svelte-csf-v5`]}}))();export{N as CustomHeader,F as DarkTheme,M as Default,P as LightTheme,j as __namedExportsOrder,E as default,T as storyAccordionItemArgTypes};