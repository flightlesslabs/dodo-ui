import{i as e}from"./preload-helper-CU4w0FXX.js";import{Gt as t,St as n,Wt as r,dn as i,dt as a,et as o,f as s,jt as c,kt as l,nn as u,nt as d,ot as f,tn as p,wt as m,xt as h}from"./iframe-Boim5DH3.js";import{U as g,ft as _,gt as v,ht as y,n as b,r as x,t as S,u as C}from"./create-runtime-stories-D_3FAyMc.js";import{f as w,m as T,t as E}from"./dist-jYHt1L2h.js";function D(e,i){t(i,!0);var s=B(),c=n(s);j(c,{name:`Default`,asChild:!0,children:(e,t)=>{var r=R(),i=n(r);_(i,{onclick:()=>l(M,!0),children:(e,t)=>{p(),o(e,f(`Open`))},$$slots:{default:!0}}),w(m(i,2),{title:`Confirm Dialog title`,get open(){return a(M)},set open(e){l(M,e,!0)},children:(e,t)=>{p(),o(e,f(`This is a basic ConfirmDialog with a title and a single action.`))},$$slots:{default:!0}}),o(e,r)},$$slots:{default:!0},parameters:{docs:{description:{story:`------------------------------`}},__svelteCsf:{rawCode:`<Button onclick={() => (openDefault = true)}>Open</Button>
...
</ConfirmDialog>`}}});var d=m(c,2);j(d,{name:`Accept Button Props`,asChild:!0,children:(e,t)=>{var r=R(),i=n(r);_(i,{onclick:()=>l(N,!0),children:(e,t)=>{p(),o(e,f(`Open`))},$$slots:{default:!0}}),w(m(i,2),{title:`Confirm Dialog title`,acceptButtonProps:{label:`Ok`,color:`safe`},get open(){return a(N)},set open(e){l(N,e,!0)},children:(e,t)=>{p(),o(e,f(`This is a basic ConfirmDialog with a title and a single action.`))},$$slots:{default:!0}}),o(e,r)},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<Button onclick={() => (openAcceptButtonProps = true)}>Open</Button>
...
>
  This is a basic ConfirmDialog with a title and a single action.
</ConfirmDialog>`}}});var g=m(d,2);j(g,{name:`Custom Accept Button`,asChild:!0,children:(e,t)=>{var r=R(),i=n(r);_(i,{onclick:()=>l(P,!0),children:(e,t)=>{p(),o(e,f(`Open`))},$$slots:{default:!0}}),w(m(i,2),{title:`Confirm Dialog title`,get open(){return a(P)},set open(e){l(P,e,!0)},customAcceptButton:e=>{_(e,{compact:!0,onclick:()=>l(P,!1),children:(e,t)=>{p(),o(e,f(`👍`))},$$slots:{default:!0}})},children:(e,t)=>{p(),o(e,f(`This is a basic ConfirmDialog with a title and a single action.`))},$$slots:{customAcceptButton:!0,default:!0}}),o(e,r)},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<Button onclick={() => (openCustomAcceptButton = true)}>Open</Button>
...
<ConfirmDialog bind:open={openCustomModalcard}>
  ...
  {/snippet}
</ConfirmDialog>`}}}),o(e,s),r()}var O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J;e((()=>{i(),v(),x(),E(),s(),b(),O=`
