import{i as e}from"./preload-helper-CU4w0FXX.js";import{Et as t,Gt as n,Pt as r,St as i,Wt as a,dn as o,dt as s,et as c,f as l,jt as u,kt as d,nt as f,wt as p}from"./iframe-CGmTcMmT.js";import{K as m,gt as h,ht as g,n as _,r as v,t as y}from"./create-runtime-stories-DBsIqukf.js";import{R as b,t as x}from"./dist-CNVjs9dK.js";function S(e,t){n(t,!0);var o=M(),l=i(o);{let e=r(()=>({type:`single`,options:w,value:s(k)}));O(l,{name:`Default`,get args(){return s(e)},parameters:{docs:{description:{story:`------------------------------`}},__svelteCsf:{rawCode:`<ToggleGroup {...args} />`}}})}var u=p(l,2);O(u,{name:`Controlled`,asChild:!0,children:(e,t)=>{b(e,{get options(){return w},type:`single`,get value(){return s(k)},set value(e){d(k,e,!0)}})},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<ToggleGroup options={options1} type="single" bind:value={value1} />`}}});var f=p(u,2);O(f,{name:`Attached`,asChild:!0,children:(e,t)=>{b(e,{get options(){return w},type:`single`,attached:!0,get value(){return s(k)},set value(e){d(k,e,!0)}})},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<ToggleGroup options={options1} type="single" bind:value={value1} attached />`}}});var m=p(f,2);O(m,{name:`Allow Deselect`,asChild:!0,children:(e,t)=>{b(e,{get options(){return w},type:`single`,allowDeselect:!0,get value(){return s(j)},set value(e){d(j,e,!0)}})},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<ToggleGroup options={options1} type="single" bind:value={value3} allowDeselect />`}}});var h=p(m,2);O(h,{name:`Mutiple`,asChild:!0,children:(e,t)=>{b(e,{get options(){return T},type:`multiple`,outline:!0,get value(){return s(A)},set value(e){d(A,e,!0)}})},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<ToggleGroup options={options2} type="multiple" bind:value={value2} outline />`}}});var g=p(h,2);O(g,{name:`Full Width and flex`,asChild:!0,children:(e,t)=>{b(e,{get options(){return w},type:`single`,fullWidth:!0,flex:!0,get value(){return s(k)},set value(e){d(k,e,!0)}})},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<ToggleGroup options={options1} type="single" bind:value={value1} fullWidth flex />`}}});var _=p(g,2);O(_,{name:`Button Style`,asChild:!0,children:(e,t)=>{b(e,{get options(){return w},type:`single`,buttonProps:{color:`safe`},activeButtonProps:{color:`safe`},get value(){return s(k)},set value(e){d(k,e,!0)}})},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<ToggleGroup
  options={options1}
  type="single"
  bind:value={value1}
  buttonProps={{
...
/>`}}}),c(e,o),a()}var C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V;e((()=>{o(),h(),v(),x(),l(),_(),C=`
