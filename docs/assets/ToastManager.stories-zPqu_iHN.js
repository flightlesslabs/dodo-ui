import{i as e}from"./preload-helper-CuCQULJj.js";import{Et as t,Gt as n,Q as r,Wt as i,dn as a,et as o,f as s,g as c,nt as l,ot as u,rn as d,tn as f,vt as p,wt as m}from"./iframe-CApopm_P.js";import{G as h,H as g,K as _,Q as v,_t as y,mt as b,n as x,r as S,t as C,vt as w}from"./create-runtime-stories-BluKH7db.js";import{a as T,n as E,o as D,t as O}from"./dist-1glt4kwT.js";function k(e,a){n(a,!0);var s=F(),l=m(s);M(l,{name:`Default`,asChild:!0,children:(e,n)=>{var r=N(),i=m(r);b(i,{onclick:()=>{T.add({title:`Toast`,description:`This is a basic toast.`,color:`danger`})},children:(e,t)=>{f(),o(e,u(`Add Toast`))},$$slots:{default:!0}}),E(t(i,2),{}),o(e,r)},$$slots:{default:!0},parameters:{docs:{description:{story:`------------------------------`}},__svelteCsf:{rawCode:`<Button
  onclick={() => {
    toasts.add({
      title: 'Toast',
