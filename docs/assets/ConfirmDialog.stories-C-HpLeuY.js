import{i as e}from"./preload-helper-B51ZT_On.js";import{$t as t,Ht as n,St as r,Ut as i,en as a,et as o,f as s,jt as c,kt as l,ln as u,lt as d,nt as f,ot as p,wt as m,xt as h}from"./iframe-3OT3fdJ0.js";import{G as g,dt as _,ht as v,mt as y,n as b,r as x,t as S,u as C}from"./create-runtime-stories-CYXmn-qB.js";import{f as w,m as T,t as E}from"./dist-B07DcFaR.js";function D(e,s){i(s,!0);var c=G(),u=r(c);j(u,{name:`Default`,asChild:!0,children:(e,n)=>{var i=R(),a=r(i);_(a,{onclick:()=>l(M,!0),children:(e,n)=>{t(),o(e,p(`Open`))},$$slots:{default:!0}}),w(m(a,2),{title:`Confirm Dialog title`,get open(){return d(M)},set open(e){l(M,e,!0)},children:(e,n)=>{t(),o(e,p(`This is a basic ConfirmDialog with a title and a single action.`))},$$slots:{default:!0}}),o(e,i)},$$slots:{default:!0},parameters:{docs:{description:{story:`------------------------------`}},__svelteCsf:{rawCode:`<Button onclick={() => (openDefault = true)}>Open</Button>
...
</ConfirmDialog>`}}});var f=m(u,2);j(f,{name:`Accept Button Props`,asChild:!0,children:(e,n)=>{var i=z(),a=r(i);_(a,{onclick:()=>l(N,!0),children:(e,n)=>{t(),o(e,p(`Open`))},$$slots:{default:!0}}),w(m(a,2),{title:`Confirm Dialog title`,acceptButtonProps:{label:`Ok`,color:`safe`},get open(){return d(N)},set open(e){l(N,e,!0)},children:(e,n)=>{t(),o(e,p(`This is a basic ConfirmDialog with a title and a single action.`))},$$slots:{default:!0}}),o(e,i)},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<Button onclick={() => (openAcceptButtonProps = true)}>Open</Button>
...
>
  This is a basic ConfirmDialog with a title and a single action.
</ConfirmDialog>`}}});var g=m(f,2);j(g,{name:`Custom Accept Button`,asChild:!0,children:(e,n)=>{var i=B(),a=r(i);_(a,{onclick:()=>l(P,!0),children:(e,n)=>{t(),o(e,p(`Open`))},$$slots:{default:!0}}),w(m(a,2),{title:`Confirm Dialog title`,get open(){return d(P)},set open(e){l(P,e,!0)},customAcceptButton:e=>{_(e,{compact:!0,onclick:()=>l(P,!1),children:(e,n)=>{t(),o(e,p(`👍`))},$$slots:{default:!0}})},children:(e,n)=>{t(),o(e,p(`This is a basic ConfirmDialog with a title and a single action.`))},$$slots:{customAcceptButton:!0,default:!0}}),o(e,i)},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<Button onclick={() => (openCustomAcceptButton = true)}>Open</Button>
...
<ConfirmDialog bind:open={openCustomModalcard}>
  ...
  {/snippet}
</ConfirmDialog>`}}}),o(e,c),n()}var O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{u(),v(),x(),E(),s(),b(),O=`
