...
<Modal bind:open={openControlsAlignment} title="Alignment Example" controlsAlignment="start">
  ...
  {/snippet}
</Modal>`}}});var g=n(f,2);j(g,{name:`Custom Title`,asChild:!0,children:(e,t)=>{var r=I(),i=h(r);v(i,{onclick:()=>u(P,!0),children:(e,t)=>{m(),c(e,p(`Open`))},$$slots:{default:!0}}),T(n(i,2),{get open(){return s(P)},set open(e){u(P,e,!0)},customTitle:e=>{S(e,{color:`danger`,children:(e,t)=>{m(),c(e,p(`⚠ Warning`))},$$slots:{default:!0}})},controls:e=>{var t=I(),r=h(t);v(r,{onclick:()=>u(P,!1),children:(e,t)=>{m(),c(e,p(`Cancel`))},$$slots:{default:!0}}),v(n(r,2),{color:`danger`,onclick:()=>u(P,!1),children:(e,t)=>{m(),c(e,p(`Delete`))},$$slots:{default:!0}}),c(e,t)},children:(e,t)=>{m(),c(e,p(`This action cannot be undone.`))},$$slots:{customTitle:!0,controls:!0,default:!0}}),c(e,r)},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<Button onclick={() => (openCustomTitle = true)}>Open</Button>
...
<Modal bind:open={openCustomTitle}>
  ...
  {/snippet}
</Modal>`}}}),j(n(g,2),{name:`Custom Modal Card`,asChild:!0,children:(e,r)=>{var i=I(),a=h(i);v(a,{onclick:()=>u(F,!0),children:(e,t)=>{m(),c(e,p(`Open`))},$$slots:{default:!0}}),T(n(a,2),{get open(){return s(F)},set open(e){u(F,e,!0)},customModalCard:e=>{w(e,{onclear:()=>u(F,!1),children:(e,r)=>{var i=L(),a=t(i);S(a,{children:(e,t)=>{m(),c(e,p(`Delete Item`))},$$slots:{default:!0}});var o=n(a,2);S(o,{children:(e,t)=>{m(),c(e,p(`Are you sure you want to delete this item? This action cannot be undone.`))},$$slots:{default:!0}});var s=n(o,2),l=t(s);v(l,{onclick:()=>u(F,!1),children:(e,t)=>{m(),c(e,p(`Cancel`))},$$slots:{default:!0}}),v(n(l,2),{color:`danger`,onclick:()=>u(F,!1),children:(e,t)=>{m(),c(e,p(`Delete`))},$$slots:{default:!0}}),d(s),d(i),c(e,i)},$$slots:{default:!0}})},$$slots:{customModalCard:!0}}),c(e,i)},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<Button onclick={() => (openCustomModalcard = true)}>Open</Button>
...
<Modal bind:open={openCustomModalcard}>
  ...
  {/snippet}
</Modal>`}}}),c(e,o),a()}var O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W;e((()=>{o(),C(),b(),E(),l(),y(),O=`
