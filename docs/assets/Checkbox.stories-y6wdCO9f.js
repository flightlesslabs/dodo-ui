import{i as e}from"./preload-helper-B51ZT_On.js";import{$t as t,Ht as n,St as r,Ut as i,et as a,f as o,jt as s,kt as c,ln as l,lt as u,nt as d,ot as f,wt as p}from"./iframe-3OT3fdJ0.js";import{Q as m,T as h,U as g,Y as _,ht as v,mt as y,n as b,q as x,r as S,t as C}from"./create-runtime-stories-CYXmn-qB.js";import{H as w,t as T}from"./dist-B07DcFaR.js";function E(e,o){i(o,!0);var s=M(),l=r(s);A(l,{name:`Default`,args:{id:`Default`},children:(e,n)=>{t(),a(e,f(`Check this text`))},$$slots:{default:!0},parameters:{docs:{description:{story:`------------------------------`}},__svelteCsf:{rawCode:`<Checkbox {...args}>
  Check this text
